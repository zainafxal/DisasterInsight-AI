...
export default function LiveFeed() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Show toast for significant new earthquakes (last hour, M6.0+)
      const significantQuakes = data.filter(
        (eq) =>
          eq.magnitude >= 6.0 &&
  ...
  const stats = {
    ...
    recent: earthquakes.filter(
      (eq) => new Date().getTime() - eq.time.getTime() < 3600000
    ).length,
  };
      ...
      <Box className={styles.header}>
        <Box className={styles.headerContent}>
          ...
          <Box className={styles.controls}>
            ...
            {/* ✅ This Box wrapper is the change */}
            <Box>
        ...
        <Box className={styles.updateBadge}>
          ...
          <Typography variant="caption">
            Last updated: {format(lastUpdate, "HH:mm:ss")} • Next update in:{" "}
                  ...
                  {["all", "major", "moderate"].map((f) => (
                    <Button
                      ...
                      sx={{
                        ...
                        borderColor:
                          filter === f ? "primary.main" : "grey.400",
                      }}
                    >
              ...
              {filteredEarthquakes.length === 0 ? (
                ...
                >
                  <Table>
                    ...
                    <TableBody>
                      <AnimatePresence>
                        {filteredEarthquakes.slice(0, 20).map(
                          (earthquake, index) => (
                            <motion.tr
                              key={earthquake.id}
                                ...
                                {(() => {
                                  ...
                                  return (
                                    <Chip
                                      ...
                                      sx={{
                                        backgroundColor:
                                          magnitudeColors.backgroundColor,
                              ...
                              <TableCell align="center">
                                <Box className={styles.depthCell}>
                                  <Box
                                    ...
                                    style={{
                                      backgroundColor: getDepthCategory(
                                        earthquake.depth
                                      ).color,
                                    }}
                                  />
